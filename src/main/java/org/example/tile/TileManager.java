...
public class TileManager {
    ...
    public void getTileImage(){
        try{
            ...
            tile[3] = new Tile();
            tile[3].image = ImageIO.read(new FileInputStream("src/main/res/tiles/earth.png"));

            tile[4] = new Tile();
            tile[4].image = ImageIO.read(new FileInputStream("src/main/res/tiles/tree.png"));
            tile[4].collision = true;

            tile[5] = new Tile();
            tile[5].image = ImageIO.read(new FileInputStream("src/main/res/tiles/sand.png"));
